...
@Component({
  selector: 'ngx-ch-employee-info',
  templateUrl: './ch-employee-info.component.html',
  styleUrls: ['./ch-employee-info.component.scss']
})
export class ChEmployeeInfoComponent implements OnInit {
  ...
  public getInitalData():void{
   this.SqlConfig.getAllEmployeeList(this.GblConfig.getEmplyeeList).subscribe(
    (res:any)=>{
